...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bullet.page'
        db.add_column(u'api_bullet', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['api.Page']),
                      keep_default=False)

        # Adding field 'Collection.page'
        db.add_column(u'api_collection', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['api.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bullet.page'
        db.delete_column(u'api_bullet', 'page_id')

        # Deleting field 'Collection.page'
        db.delete_column(u'api_collection', 'page_id')
